	...
	fromJSON(object: any): ResponseEndBlock {
		return {
			...
			validatorUpdates: Array.isArray(object?.validatorUpdates)
				? object.validatorUpdates.map((e: any) =>
...
export class ABCIApplicationClientImpl implements ABCIApplication {
	...
	Echo(request: RequestEcho): Promise<ResponseEcho> {
		...
		return promise.then((data) =>
			ResponseEcho.decode(new _m0.Reader(data))
		);
	}
	...
	Flush(request: RequestFlush): Promise<ResponseFlush> {
		...
		return promise.then((data) =>
			ResponseFlush.decode(new _m0.Reader(data))
		);
	}
	...
	Info(request: RequestInfo): Promise<ResponseInfo> {
		...
		return promise.then((data) =>
			ResponseInfo.decode(new _m0.Reader(data))
		);
	}
	...
	Query(request: RequestQuery): Promise<ResponseQuery> {
		...
		return promise.then((data) =>
			ResponseQuery.decode(new _m0.Reader(data))
		);
	}
	...
	Commit(request: RequestCommit): Promise<ResponseCommit> {
		...
		return promise.then((data) =>
			ResponseCommit.decode(new _m0.Reader(data))
		);
	}
